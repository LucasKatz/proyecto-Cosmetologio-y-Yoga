    ...
    <>
      ...
      <section className="row justify-content-center align-items-center">
        ...
        >
          ...
          <h4>
        <strong id="skincareText" style={{ color: "#5B3619" }}>¿Qué es Skincare?</strong>
      </h4>
          <p  id="skincareText" className="text-center m-0" style={{ color: "#5B3619" }}>
            ...
            <p id="skincareText" className="text-center m-0 pb-4" style={{ color: "#5B3619" }}>
            ¡Te espero!
          </p>
          </div>
          </div>
